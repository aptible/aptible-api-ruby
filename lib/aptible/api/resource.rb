...
require 'aptible/api/managed_vpn_tunnel'
require 'aptible/api/vpn_tunnel_configuration'
require 'aptible/api/vpn_tunnel_configuration_vhost'
require 'aptible/api/route'
